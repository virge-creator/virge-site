...
**Coinbase launched [Agentic Wallets](https://www.coinbase.com/developer-platform/discover/launches/agentic-wallets)** — crypto wallets purpose-built for AI agents. These wallets let AI systems hold funds, execute trades, pay fees, and earn yield autonomously. No human approval needed for each transaction.

**Uniswap released [AI Skills](https://www.tronweekly.com/uniswap-launches-ai-skills-upgrade-enabling/)** — enabling AI agents to autonomously trade and manage liquidity on decentralized exchanges.
...
That last point is crucial. As Coinbase [explicitly states](https://www.webpronews.com/coinbase-hands-ai-agents-the-keys-to-crypto-inside-the-bold-bet-on-autonomous-wallets-that-could-reshape-digital-finance/): autonomy doesn't mean unlimited access. Developers set the boundaries. The agent operates within them. Private keys stay in Coinbase's secure infrastructure.
...
*At Virge.io, we help businesses navigate the intersection of AI and operations — from [RAG pipelines](/en/ai/) to [automated content](/en/ecommerce/content/) to AI agent architecture. Want to explore what autonomous AI agents could do for your business? [Let's talk](/en/contact/).*
