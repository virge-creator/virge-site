...
|----------|--------------|----------|----------|
| **LLMs** | Predict next token in text sequences | Language tasks, coding, reasoning | No physical world understanding |
| **World Models** | Learn causal relationships in physical reality | Robotics, embodied AI, planning | Still largely theoretical |
