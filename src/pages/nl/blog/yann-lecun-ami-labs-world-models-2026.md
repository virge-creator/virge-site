...
1. **LLMs zullen fundamentele limieten bereiken** die niet opgelost kunnen worden met meer schaal
2. **World models zijn bouwbaar** met huidige (of nabije toekomstige) technologie
3. **Een startup kan Big Tech verslaan** in fundamenteel AI-onderzoek
4. **De markttiming is juist** voor een paradigmaverschuiving
